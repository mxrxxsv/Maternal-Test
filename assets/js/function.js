const questions = {
  ...
  theoriesOfLabor: [
    ...
    },
    {
      ...
      },
      {
        ...
        options: ["Uterine muscle stretching", "Oxytocin stimulation", "Rising fetal cortisol levels", "Placental age"],
        answer: 0,
        clues: [],
      },
      {
      ...
      },
      {
        ...
        options: ["Slight loss of weight", "Oxytocin stimulation", "Rising fetal cortisol levels", "Ripening of the cervix"],
        answer: 0,
        clues: [],
      },
      {
        ...
        options: ["Slight loss of weight", "Increase in Level of Activity", "Rising fetal cortisol levels", "Ripening of the cervix"],
        answer: 1,
        clues: [],
      },
      {
        ...
        options: ["Oxytocin stimulation", "Uterine muscle stretching", "Ripening of the cervix ", "Placental age"],
        answer: 2,
        clues: [],
      },
      {
        ...
        options: ["Uterine muscle stretching", "Oxytocin stimulation", "Braxston Hicks Contraction", "Placental age"],
        answer: 2,
        clues: [],
      },
      {
        question:
          "Age of viability",
        options: ["20 weeks or 22 weeks of amenorrhea (WHO)", "22 weeks or 24 weeks of amenorrhea (WHO)", "10 weeks or 22 weeks of amenorrhea (WHO)", "Placental 27 weeks or 32 weeks of amenorrhea (WHO)"],
        answer: 0,
        clues: [],
      },
      {
        question:
          "Extremely Preterm (prone in infection)",
      ...
      {
        question:
          "Preterm (can live outside the uterus)",
        options: ["less than 256 days", "less than 259 days", "less than 243 days", "less than 250 days"],
        answer: 1,
        clues: [],
      },
      {
        question:
          "Term",
        options: ["259 days-294 days", "252 days-296 days", "257 days-293 days", "252 days-290 days"],
        answer: 2,
        clues: [],
      },
      {
  ...
  fetalPresentation: [
    {
      question:
        "Which fetal presentation is most favorable for a natural vaginal delivery?",
      options: ["Breech", "Transverse", "Vertex", "Face"],
      answer: 2,
      clues: [],
    },
...
function nextQuestion() {
  ...
  if (currentQuestion < selectedQuestions.length) {
    document.getElementById("testNumber").textContent = `${score / 10}`+ `/` + selectedQuestions.length;
    displayQuestion();
    startTimer();
  } else {
    endQuiz();
